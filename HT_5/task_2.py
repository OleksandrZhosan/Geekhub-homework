...
ці гроші додаються до суми вкладу і в наступному році на них також нараховуються
відсотки). Параметр <percents> є необов'язковим і має значення
...
print('Введіть сумму вкладу, термін та % ставку (опціонально) через кому, наприклад: 1000,5,10')
arguments = map(int, input().split(','))

print(f'У Вас на рахунку буде {round(bank(*arguments), 2)} грн')
